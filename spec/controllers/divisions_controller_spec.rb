...
RSpec.describe DivisionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested division as @division" do
      division = Division.create! valid_attributes
      get :show, params: {id: division.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested division as @division" do
      division = Division.create! valid_attributes
      get :edit, params: {id: division.to_param}, session: valid_session
      expect(assigns(:division)).to eq(division)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Division" do
        expect {
          post :create, params: {division: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved division as @division" do
        post :create, params: {division: invalid_attributes}, session: valid_session
        expect(assigns(:division)).to be_a_new(Division)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested division" do
        division = Division.create! valid_attributes
        put :update, params: {id: division.to_param, division: new_attributes}, session: valid_session
        division.reload
      ...
      it "assigns the requested division as @division" do
        division = Division.create! valid_attributes
        put :update, params: {id: division.to_param, division: valid_attributes}, session: valid_session
        expect(assigns(:division)).to eq(division)
      end
    ...
    context "with invalid params" do
      it "assigns the division as @division" do
        division = Division.create! valid_attributes
        put :update, params: {id: division.to_param, division: invalid_attributes}, session: valid_session
        expect(assigns(:division)).to eq(division)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested division" do
      division = Division.create! valid_attributes
      expect {
        delete :destroy, params: {id: division.to_param}, session: valid_session
      }.to change(Division, :count).by(-1)
    end
